...
Once you have a dataset, you will use your R skills to tidy the data and provide basic descriptive statistics and visualizations in a reproducible report. 
All steps/answers/etc. must be documented and reproducible.

**Assigned**: Week 11 (4/11)  
**Due**: Monday, 4/18 before 10pm
...
All the participants were recorded saying nonse words in Spanish (or what they believed to be Spanish). 
...
After you fork the repo, you should clone it to your computer using the github app and work with it from there. 
